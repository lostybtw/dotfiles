...
import Graphics.X11.ExtraTypes.XF86 
     (xF86XK_AudioLowerVolume, xF86XK_AudioRaiseVolume, xF86XK_AudioMute, xF86XK_MonBrightnessDown, xF86XK_MonBrightnessUp, xF86XK_AudioPlay, xF86XK_AudioPrev, xF86XK_AudioNext)
...
--
myWorkspaces    = ["clutter","cli&productivity + emacs","media","class","etc","5","6","7","8","9"]
...
myLayout = fullscreenFull  $ spacingRaw True (Border 10 10 10 10) True (Border 10 10 10 10) True
    
     $avoidStruts( gaps [(U,20),(D,25),(L,25),(R,25)] $ tiled ||| Mirror tiled ||| noBorders Full)  -- leave gaps at the top and right
        where
...
myStartupHook = do
        ...
        spawnOnce "xmobar &"
        spawnOnce "~/.fehbg"
        spawnOnce "trayer --edge bottom --width 10 --align center --transparent true --alpha 255 &"
        spawnOnce "nm-applet &"
        spawnOnce "volumeicon &"
        spawnOnce "dunst &"
        spawnOnce "edex-ui"
        spawnOnce "alacritty -e vim ~/orgs/startup.md"
...
main :: IO ()
main = do
    xmproc <- spawnPipe "xmobar -x 0 /home/lostancient/.config/xmobar/xmobarrc"
    xmonad $ docks defaults
    xmonad $ def { handleEventHook = setTransparentHook <+> handleEventHook def }
    xmonad $ docks def
  ...
  -- 'MirrorExpand' messages.
    --XMONAD $ def { layoutHook = spacingWithEdge 10 $ myLayout}
